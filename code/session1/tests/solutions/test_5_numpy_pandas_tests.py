...
def test_numpy():
    ...
    np.testing.assert_allclose(expected_outputs, outputs, atol=0.00001)
...
def test_pandas():
    ...
    expected_counts = [1, 2, 0, 3]  # REMOVE
    ...
    expected_counts_series = pd.Series(
        expected_counts, index=expected_index, name="events"
    )  # REMOVE
